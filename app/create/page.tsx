...
export default function CreatePage() {
  ...
  return (
    <div className="page-shell">
      {/* 헤더 */}
      <header style={{
        height: 56, borderBottom: "1px solid rgba(0,0,0,0.07)",
      ...
      <main className="page-main page-main--wide">
        <div style={{ marginBottom: 40 }}>
          <h1 className="heading-xl">템플릿을 선택하세요</h1>
          <p className="sub-text">포맷과 템플릿을 고른 후 에디터로 이동합니다</p>
        </div>
        ...
        <div className="home-layout">
          {/* 왼쪽: 템플릿 그리드 */}
          <div>
            <div className="label-sm" style={{ marginBottom: 14, letterSpacing: "0.05em" }}>
              템플릿 선택
            </div>
                ...
                >
                  ...
                  >
                    <span style={{
                      ...
                      fontWeight: 700, color: t.textColor, opacity: 0.7,
                    }}>나무카드.</span>
                  </div>
                  <div className={`template-name${templateId === t.id ? " template-name--selected" : ""}`}>
                    {t.name}
                  </div>
                </button>
              ))}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <div>
              ...
              <div style={{
                ...
                <div style={{
                  fontFamily: "var(--f-head)", fontSize: 18,
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                    <div className="play-circle" style={{ width: 20, height: 20 }}>
                      <div className="play-triangle" style={{
                        borderTopWidth: 3, borderBottomWidth: 3, borderLeftWidth: 5,
                      }} />
                    </div>
                    <span style={{
                      fontFamily: "var(--f-head)", fontSize: 10,
            ...
            <Link href="/editor" className="btn btn-primary btn-lg" style={{
